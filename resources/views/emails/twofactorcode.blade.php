                                    ...
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <p
                                                ...
                                                Bonjour cher(e) {{ $body->data['nom'] }},

                                            <p>Vous avez activé la double authentification sur votre compte.
                                                <br>
                                                Veuillez utiliser le code de
                                                vérification suivant pour vous connecter a votre compte : <br>
                                                Code de vérification : <b>{{ $body->data['code'] }}</b> <br>
                                                Entrez ce code dans la section dédiée sur la plateforme
                                                pour vous connecter  votre compte.
                                                <br>
                                                Si vous n'avez pas activé la double authentification, veuillez ignorer
                                                cet e-mail. <br>
